...
var Administrator = function Administrator(props) {
  ...
  var handleModal = showModal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
  ...
  }, "Company Name"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "Street Name"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'Street Name',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "Street Address"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "City"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "Country"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "Website"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "Your Name"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
    ...
    htmlFor: 'text',
    className: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white'
  }, "Your function"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", {
    type: 'text',
    name: 'email',
    id: 'email',
    className: 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("dda0072c65609c5a092e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.86d33b71abd4d947182c.hot-update.js.map