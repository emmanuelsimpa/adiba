...
function FlyoutMenu() {
  ...
  var handleSwitch = function handleSwitch(e) {
    console.log("handleSwitch", e.target.name);
  ...
  return (
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_headlessui_react__WEBPACK_IMPORTED_MODULE_9__.Popover, {
      className: 'relative'
    }, function (_ref) {
      var open = _ref.open;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bdc4afbd3847714d9a45")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.fe9a7eac42635c0ec6ff.hot-update.js.map