...
const stats = [
  ...
  { id: 4, name: 'Avg. Text Rate', stat: '24.57%', icon: CursorArrowRaysIcon, change: '3.2%', changeType: 'decrease' },
]
...
export default function StatsCard(props: React.PropsWithChildren<StatsCardProps>) {
