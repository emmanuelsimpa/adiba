...
/* harmony import */ var _redux_redux_authRedux__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../redux/_redux/authRedux */ "./src/member/redux/_redux/authRedux.js");
...
function SignInContent() {
  ...
  var handleSubmit = function handleSubmit(event) {
    ...
    dispatch(_redux_redux_authRedux__WEBPACK_IMPORTED_MODULE_5__.actions.login(state));
    (0,_redux_redux_authCrud__WEBPACK_IMPORTED_MODULE_4__.logins)({
      email: email,
      password: password
    }).then(function (response) {
      console.log(response.data);
      dispatch(_redux_redux_authRedux__WEBPACK_IMPORTED_MODULE_5__.actions.login(data.accessToken));
      var data = response.data;
      console.log(response);
      if (response.status === 200) {
        dispatch(_redux_redux_authRedux__WEBPACK_IMPORTED_MODULE_5__.actions.login(data));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("abae0be842ba85d02213")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.f0a511d1063a6dbdaa64.hot-update.js.map